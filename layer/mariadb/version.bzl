# load("@mariadb_10_5_jammy_amd64//debs:deb_packages.bzl", "mariadb_10_5_jammy_amd64")
# load("@mariadb_10_5_jammy_arm64//debs:deb_packages.bzl", "mariadb_10_5_jammy_arm64")
...
# load("@mariadb_10_6_jammy_amd64//debs:deb_packages.bzl", "mariadb_10_6_jammy_amd64")
# load("@mariadb_10_6_jammy_arm64//debs:deb_packages.bzl", "mariadb_10_6_jammy_arm64")
...
# load("@mariadb_10_7_jammy_amd64//debs:deb_packages.bzl", "mariadb_10_7_jammy_amd64")
# load("@mariadb_10_7_jammy_arm64//debs:deb_packages.bzl", "mariadb_10_7_jammy_arm64")
...
def mariadb_package(version, package):
    return select({
            ...
            #     mariadb_10_5_jammy_amd64[package] if (version == "10.5")
            #     else mariadb_10_6_jammy_amd64[package] if (version == "10.6")
            #     else mariadb_10_7_jammy_amd64[package] if version == "10.7" else "",
            # ],
            # "//platforms:aarch64_cpu_jammy": [
            #     mariadb_10_5_jammy_arm64[package] if (version == "10.5") 
            #     else mariadb_10_6_jammy_arm64[package] if (version == "10.6")
            #     else mariadb_10_7_jammy_arm64[package] if version == "10.7" else "",
            # ],
