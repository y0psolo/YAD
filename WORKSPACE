...
http_archive(
    ...
    sha256 = "d80a7dffcbef61b710e816ef568ee790c5ad6c743f0a99ddba4bd1069e574c54",
    type = "zip",
    urls = ["https://github.com/denoland/deno/releases/download/v1.16.0/deno-x86_64-unknown-linux-gnu.zip"],
)
