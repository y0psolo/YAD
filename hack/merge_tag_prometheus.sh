...
ALERT_VERSION=$(grep ALERTMANAGER_VERSION update/constants.bzl | grep -o -m 1 -E "[0-9]+.[0-9]+.[0-9]+")
...
simple_tag_multi_arch alertmanager $1 ${ALERT_VERSION}
simple_tag_multi_arch alertmanager $1 latest