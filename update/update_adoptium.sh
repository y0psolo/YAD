...
VERSION=$(git ls-remote -t --exit-code --refs --sort=-v:refname https://github.com/adoptium/temurin17-binaries.git | grep -o -m 1 -E "jdk-17\+[0-9]+$")
RELEASE_VERSION="${VERSION:4}"
VERSION1=${RELEASE_VERSION%+*}
VERSION2=${RELEASE_VERSION#*+}
URL_17_AMD64=https://github.com/adoptium/temurin17-binaries/releases/download/$VERSION/OpenJDK17-jdk_x64_linux_hotspot_${VERSION1}_$VERSION2.tar.gz
