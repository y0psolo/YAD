...
write_rule alertmanager_amd64 alertmanager_amd64 https://github.com/prometheus/alertmanager/releases/download/v$VERSION_ALERT/alertmanager-$VERSION_ALERT.linux-amd64.tar.gz "" prometheus
write_rule alertmanager_arm64 alertmanager_arm64 https://github.com/prometheus/alertmanager/releases/download/v$VERSION_ALERT/alertmanager-$VERSION_ALERT.linux-arm64.tar.gz "" prometheus
